...
from main import (
    display_languages, get_input, translate_text, process_translations, LANGUAGES,
    create_ascii_title, sort_colors, is_valid_language, is_non_empty, parse_languages,
    are_valid_languages
)
...
class TestTranslator(unittest.TestCase):
    ...
    def test_process_translations(self, mock_update, mock_add_task, mock_translate_text):
        mock_translate_text.side_effect = ['Hola, mundo!', 'Bonjour, le monde!']
        results = process_translations('Hello, world!', 'English', ['Spanish', 'French'])
